      ...
      <View style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.additionalProperties}>
            <Text>Pesticide Name: <Text style={styles.additionalText}>{cardInfo.pesticideName[1]}</Text></Text>
            <Text>Pesticide Category: <Text style={styles.additionalText}>{cardInfo.pesticideCategory[2]}</Text></Text>
            <Text>Rating: <Text style={styles.additionalText}>{cardInfo.rating[1]}</Text></Text>
            <Text>Product Rate: <Text style={styles.additionalText}>{cardInfo.productRate[1]}</Text></Text>
          </View>
        </View>
      </View>
    </ScrollView>
