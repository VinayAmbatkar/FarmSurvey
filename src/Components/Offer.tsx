        ...
        >
            <View style={styles.wrapper}>
                <View style={styles.sectionOne}>
                    <Text style={styles.textHeader}>Share Your Pesticide Preferences.</Text>
                    {/* <Text style={styles.textParagraph}>Get Special Offer</Text> */}
                    <TouchableOpacity style={styles.buttonContainer} onPress={props.onPress}>
                        <Text style={styles.buttonText}>Give Survey</Text>
                        
                    </TouchableOpacity>
                </View>

                <View style={styles.sectionTwo}>
                    <Image source={require('../Images/SURVEY.png')} style={styles.image} />
                </View>
            </View>
    </LinearGradient>
  )
